...
class EESPNet_Seg(nn.Module):
    def __init__(self, classes=20, s=1):
        ...
        #for i, k in enumerate(classificationNet.state_dict().keys()):
        #    classificationNet.state_dict()['module.'+k] = classificationNet.state_dict()[k].pop()
        print('classificationNet: ', classificationNet.state_dict().keys())
